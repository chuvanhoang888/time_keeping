...
import 'package:app_cham_cong_option_2/screen/dts/components/check_in_location_screen.dart';
import 'package:app_cham_cong_option_2/screen/dts/components/tag_screen.dart';
...
class _DtsNewPostState extends State<DtsNewPost> with TickerProviderStateMixin {
  ...
  Widget _previewImages(Size size) {
    ...
    if (fileImageArray.length == 1) {
      if (getUrlType(fileImageArray[0].path) == 1) {
        return Stack(
          alignment: Alignment.topRight,
          children: [
            CardVideoPlayFile(
              view: true,
              pathh: fileImageArray[0],
            ),
            Positioned(
              top: 5,
              right: 5,
      ...
      return StaggeredGridView.countBuilder(
          ...
          itemBuilder: (context, index) {
            if (getUrlType(fileImageArray[index].path) == 1) {
              return Stack(
                alignment: Alignment.topRight,
                children: [
                  CardVideoPlayFile(
                    pathh: fileImageArray[index],
                  ),
                  Positioned(
                    top: 5,
                    right: 5,
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        ...
        child: Scaffold(
                          ...
                          if (_editTextController.text.isNotEmpty) {
                            ...
                            postsViewModel
                                .createPostDts(
                                    ...
                                    nowTime.toString(),
                                    fileImageArray,
                                    postUserTagViewModel.listMember)
                                .whenComplete(() {
                              EasyLoading.dismiss();
                            });
                          } else {
            ...
            body: _ui(authViewModel, size, radius, postUserTagViewModel)));
  }
        ...
        children: [
                                        ...
                                        postUserTagViewModel
                                            ...
                                            ? const TextSpan(
                                                ...
                                                style: TextStyle(
                                                    ...
                                                    fontSize: 18))
                                            : const TextSpan(),
                                        postUserTagViewModel.listMember.length >
                                                1
                                            ? TextSpan(
                                                text: (postUserTagViewModel
                                                                .listMember
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ButtonAdd(
                  icon: "assets/icons/wallpapers.png",
                  text: "Ảnh/Video",
                  onPress: () {
                    goToSecondScreen();
                  },
    ...
    return Material(
        ...
        child: InkWell(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  SizedBox(height: 40, width: 30, child: Image.asset(icon)),
                  const SizedBox(
                    width: 3,
                  ),
                  Text(text)
...
class CardVideoPlayFile extends StatefulWidget {
  final File? pathh;
  final bool view;
  const CardVideoPlayFile({Key? key, this.pathh, this.view = false})
      : super(key: key);

  @override
  State<CardVideoPlayFile> createState() => _CardVideoPlayFileState();
}

class _CardVideoPlayFileState extends State<CardVideoPlayFile> {
  ...
  initVideo() {
    _videoController = VideoPlayerController.file(widget.pathh!);
